...
| `enableRequestAnimationFrame` | `boolean`                                     | Improve performance by throttling/debouncing multiple scrolling events using `window.requestAnimationFrame`. Defaults to **true**.                                                                                                                               |
